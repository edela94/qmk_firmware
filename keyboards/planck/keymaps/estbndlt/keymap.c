 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Pscrn| Esc  | Alt  | GUI  |Lower | Vim  |Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_PSCR, KC_ESC,  KC_LALT, KC_LGUI, LOWER,   VIM,     KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Pscrn| Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Pscrn| Esc  | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
